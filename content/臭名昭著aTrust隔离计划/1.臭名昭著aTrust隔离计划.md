...
![OrbStack 界面](image/Pasted%20image%2020260811153057.webp)

- **VNC Viewer**: 用于访问容器内的图形界面（aTrust 登录框）。 -我用的是TigerVNC https://tigervnc.org/
![TigerVNC 界面](image/Pasted%20image%2020260811153123.webp)
...
![Proxifier 代理配置](image/Pasted%20image%2020260811161750.webp)
1. **Rules 设置**：
...
![Proxifier 规则配置](image/Pasted%20image%2020260811161811.webp)
