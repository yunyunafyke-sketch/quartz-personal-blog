...
![macOS 上 aTrust 隔离与流量分流架构](image/atrust-network-isolation.webp)
...
- **OrbStack**: macOS 上 Docker Desktop 的最佳替代品，轻量且网络互通性极好。
  ...
  ![](image/Pasted%20image%2020260903220630.webp)
...
- **VNC Viewer**: 用于访问容器内的图形界面（aTrust 登录框）。 -我用的是TigerVNC <https://tigervnc.org/> <img class="pet-icon" src="1.臭名昭著aTrust隔离计划.assets/NO.S1异色_疾光千兽.webp" alt="疾光千兽" width="56">
  ...
  ![](image/Pasted%20image%2020260903220554.webp)
...
![在终端启动 aTrust 容器](image/Pasted%20image%2020260811153314.webp)
...
![进入 FlClash 配置页面](image/Pasted%20image%2020260811152402.webp)

第二步  选择 '覆写'

![选择覆写配置](image/Pasted%20image%2020260811152412.webp)

选择 '脚本'

![选择脚本配置](image/Pasted%20image%2020260811152547.webp)

选择 '前往配置脚本'

![前往配置脚本](image/Pasted%20image%2020260811152622.webp)

选择 '添加'

![添加 FlClash 配置脚本](image/Pasted%20image%2020260811152701.webp)

将下列脚本复制粘贴到里面并保存

![编辑 FlClash 配置脚本](image/Pasted%20image%2020260811152718.webp)
