---
publish: true
title: 1.臭名昭著aTrust隔离计划
date: 2026-08-12
---

## 原文地址

<https://smc.im/post/macos-resolve-atrust-clash-tun-conflict-with-docker/#%e8%a7%a3%e5%86%b3%e6%80%9d%e8%b7%af%20%E8%BF%99%E4%B8%AA%E5%91%A2> <img class="pet-icon" src="1.臭名昭著aTrust隔离计划.assets/NO.000_蓬叶虫（金黄的样子）.webp" alt="蓬叶虫（金黄的样子）" width="56">
...
2. **关闭 Tun 模式**：aTrust 正常了，但google等服务 无法正常使用。

aTrust 太恶心！

一个好玩的项目：[docker-easyconnect](https://github.com/docker-easyconnect/docker-easyconnect) <img class="pet-icon" src="1.臭名昭著aTrust隔离计划.assets/NO.081_星光狮.webp" alt="星光狮" width="56">。
...
![macOS 上 aTrust 隔离与流量分流架构](1.臭名昭著aTrust隔离计划.assets/atrust-network-isolation.webp)

[打开交互式架构图](../archify/atrust-network-isolation.html) <img class="pet-icon" src="1.臭名昭著aTrust隔离计划.assets/NO.356_爆焰仔.webp" alt="爆焰仔" width="56">
...
- **OrbStack**: macOS 上 Docker Desktop 的最佳替代品，轻量且网络互通性极好。
  ...
  ![](1.臭名昭著aTrust隔离计划.assets/Pasted%20image%2020260903220630.webp)

- **VNC Viewer**: 用于访问容器内的图形界面（aTrust 登录框）。 -我用的是TigerVNC <https://tigervnc.org/> <img class="pet-icon" src="1.臭名昭著aTrust隔离计划.assets/NO.S1异色_疾光千兽.webp" alt="疾光千兽" width="56">

  ![](1.臭名昭著aTrust隔离计划.assets/Pasted%20image%2020260903220554.webp)

- **Clash**: 我使用的是 FlClash，支持 Tun 模式即可。

### 2. 部署 aTrust 容器

这里使用 [docker-easyconnect](https://github.com/docker-easyconnect/docker-easyconnect) <img class="pet-icon" src="1.臭名昭著aTrust隔离计划.assets/NO.S1异色_窃光蚊.webp" alt="窃光蚊" width="56"> 这个项目。相比于直接 docker run，我更习惯用 docker-compose 管理，方便后续调整参数。
...
![在终端启动 aTrust 容器](1.臭名昭著aTrust隔离计划.assets/Pasted%20image%2020260811153314.webp)
...
- 下载 [**VNC Viewer**](https://tigervnc.org/) <img class="pet-icon" src="1.臭名昭著aTrust隔离计划.assets/NO.000_古钟蛇（本命年的样子）.webp" alt="古钟蛇（本命年的样子）" width="56">，然后打开。
...
![进入 FlClash 配置页面](1.臭名昭著aTrust隔离计划.assets/Pasted%20image%2020260811152402.webp)

第二步  选择 '覆写'

![选择覆写配置](1.臭名昭著aTrust隔离计划.assets/Pasted%20image%2020260811152412.webp)

选择 '脚本'

![选择脚本配置](1.臭名昭著aTrust隔离计划.assets/Pasted%20image%2020260811152547.webp)

选择 '前往配置脚本'

![前往配置脚本](1.臭名昭著aTrust隔离计划.assets/Pasted%20image%2020260811152622.webp)

选择 '添加'

![添加 FlClash 配置脚本](1.臭名昭著aTrust隔离计划.assets/Pasted%20image%2020260811152701.webp)

将下列脚本复制粘贴到里面并保存

![编辑 FlClash 配置脚本](1.臭名昭著aTrust隔离计划.assets/Pasted%20image%2020260811152718.webp)
...
- [https://github.com/docker-easyconnect/docker-easyconnect](https://github.com/docker-easyconnect/docker-easyconnect) <img class="pet-icon" src="1.臭名昭著aTrust隔离计划.assets/NO.127_古啦多.webp" alt="古啦多" width="56">
- [https://linux.do/t/topic/1192827](https://linux.do/t/topic/1192827) <img class="pet-icon" src="1.臭名昭著aTrust隔离计划.assets/NO.S1异色_粉星仔.webp" alt="粉星仔" width="56">
- [https://www.v2ex.com/t/1174715](https://www.v2ex.com/t/1174715) <img class="pet-icon" src="1.臭名昭著aTrust隔离计划.assets/NO.S2异色_幽影树.webp" alt="幽影树" width="56">
- [https://gemini.google.com](https://gemini.google.com/) <img class="pet-icon" src="1.臭名昭著aTrust隔离计划.assets/NO.000_石冠王蜥（本来的样子）.webp" alt="石冠王蜥（本来的样子）" width="56">
